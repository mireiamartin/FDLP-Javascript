class Vol{
    ...
    //si no queremos que se pueda modificar alguno, no se pone su setter.
    set vol (param){
    ...
    calcularPetjada(){
        return (this._tones * (this._distancia / this._mil)) * this._motors
    }
    // calcularPetjada(){
    //     return this._tones * (this._distancia/this._mil)
